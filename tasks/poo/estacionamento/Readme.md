...
![_](../../.tko/cache/poo/base/estacionamento/cover.jpg)
...
## Guide
[![youtube icon](../../.tko/cache/poo/base/estacionamento/../yousolver.png)](https://youtu.be/PBabGC5nlPE?si=NgkxkLArCDVx52fJ)

![_](../../.tko/cache/poo/base/estacionamento/diagrama.png)
...
<!-- links .cache/draft -->
- cpp
  - [shell.cpp](../../.tko/cache/poo/base/estacionamento/.cache/draft/cpp/shell.cpp)
- java
  - [Shell.java](../../.tko/cache/poo/base/estacionamento/.cache/draft/java/Shell.java)
- ts
  - [shell.ts](../../.tko/cache/poo/base/estacionamento/.cache/draft/ts/shell.ts)
<!-- links -->
